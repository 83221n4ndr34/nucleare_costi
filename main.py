...
st.markdown("In particolare questo applicativo ha lo scopo di stimare l'impatto sui conti pubblici di un programma energetico nucleare finanziato interamente con soldi pubblici, anche se i risultati possono essere interpretati in modo più generale.")
...
st.markdown(" - **La costruzione fissa di 1 reattore all'anno, senza inoltre considerare differenza fra reattori nella stessa centrale o in sedi diversi*")
...
st.markdown(" - **La mancata modellizzazione dell'intero mix elettrico e quindi del costo dell'elettricità (o pià in generale energia considerando anche potenziale calore per industrie e riscaldamenti)**")
...
####### manca oltre ai controlli dei plot, cumulativi, pop up
####### ed al testo latex per i paper su scenari
####### magari un controllo al testo introduttivo
